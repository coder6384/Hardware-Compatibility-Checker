...
<main class="container-fluid">
    ...
    <h1 class=text-primary><u>Learn about computer hardware</h1>
    <p class=text-dark>
    ...
    <h1 class=text-dark>Storage</h1>
    <p class=text-dark>Computers have similar ways of storing their data but the difference comes to how the storage
        location
        looks like when seen there are the common types known as the Hard Disk Drive or HDD and there is also the solid
        state drive.
    </p>
    <h3 class=text-dark>(a) HDDs </h3>
    <p class=text-dark>HDDs come in various types the modern most common one is the SATA found in many computers that
        have a
    ...
    <img src=documentation/harddisk.jpg width="100" height="100">

    <h3 class=text-dark>(b) sDDs </h3>
    <p class=text-dark>SDDs lack spining disks like the HDDs but have memory chips inside them, they have been used
        in
    ...
    <img src=documentation/solidstate.jpg width="120" height="120">
    <h1 class=text-dak>RAM</h1>
    <p class=text-dark>The random Access Memory has various versions depending on how old the computer is or what
    ...
    <img src=documentation/ram.jpeg width="190" height="120">

    <h1 class=text-dark>CPU</h1>
    <p class=text-dark>Even though computer hardware has changed visually over the past couple of years CPU chips
        havent changed
    ...
    <img src=documentation/cpu.jpeg width="120" height="100">
    <h1 class=text-dark>Connector pins</h1>
    <p class=text-dark> Computers usually have a connector pin at the end of the charger that is also the power supply
        unit for
        laptops. Connector pins are classified into either male or female, the male has a thin sharp pin inside that
        plugs into
        the power port of the computer while the female port has a plug inside it that is plugged into with a pin that
        is inside
        the power port of the computer.These ports are further categorized as per the thickness that these ports have.
        The image
        below shows the different sizes of ports.
        <img src=documentation/ports.webp width="600" height="500">
